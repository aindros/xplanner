...
//        g.setXORMode(Color.BLACK);
    ...
    public void encodeJPEG( OutputStream outputStream, float outputQuality )
       ...
       // Note that additional drawing such as watermarks or logos can be placed here.
        ...
        //oldEncoder(outputStream, bi, outputQuality);
        newEncoder(bi, outputStream);

       outputStream.flush();
    } // encodeImage

    /*
    private void oldEncoder(OutputStream outputStream, BufferedImage bi, float outputQuality) {
    ...
    private void newEncoder(BufferedImage bufferedImage, OutputStream outputStream) throws IOException {
