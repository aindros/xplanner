...
public class PDFRender implements Render {
	@Override
	public void render(File fileToRender, HttpServletResponse response) throws IOException {
		FileInputStream inputStream = new FileInputStream(fileToRender);
		...
		response.setHeader("Content-Disposition","inline; filename=\"" + fileToRender.getName() + "\"");
